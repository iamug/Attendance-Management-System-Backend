...
class HttpResponse {
    ...
    static FORBIDDEN(res, payload = null) {
        let msg = payload !== null ? payload : "You are not allowed to access this resource";
    ...
    static BAD_GATEWAY(res, payload = null) {
        let msg = payload !== null ? payload : "Invalid response from upstream server";
