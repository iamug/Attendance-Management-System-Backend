interface IWrite {
    ...
    updateMany(columnName: string, pointers: Array<number | string>, item: object): Promise<boolean>;
    deleteById(id: number | string): Promise<boolean>;
    deleteWhere(condition: object): Promise<boolean>;
    deleteMany(columnName: string, pointers: Array<number | string>): Promise<boolean>;
}
export default IWrite;
//# sourceMappingURL=IWrite.d.ts.map