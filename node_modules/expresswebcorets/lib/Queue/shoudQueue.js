...
//@ts-ignore
const queue_js_1 = __importDefault(require("../../../../build/Config/queue.js"));
class ShouldQueue extends QueueManager_1.default {
    constructor() {
        super();
        this.job = null;
        this.signature = "";
        this.connection = this.getConnection(queue_js_1.default.default);
    ...
    getConnection(connection) {
        if (connection != null) {
            try {
                return queue_js_1.default.connections[connection];
            }
            catch (error) {
                console.log(error);
                return null;
